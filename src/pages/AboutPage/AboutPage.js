            ...
            <div className="container">
                {/* <div className="py-sm-1 py-1">
                    <h3 className="tittle">
                        <span>A</span>bout
                <span>U</span>s</h3> */}
                {/* <h2 className="font-italic text-center mb-4 mb-lg-5 mb-sm-4 mb-3"> A platform supports for most of
                social activities in a fastest way ever</h2> */}
                {/* <div className="row"> */}
                {/* <div className="col-lg-6"> */}
                {/* <p>We are here to solve a problem: In a world where we can order anything we need online and
                        have it arrive at our doorstep, collecting goods for charity using cardboard boxes seemed like a
                        system ripe for disruption.
                        We decided the best way to tackle this outdated system was to use the e-commerce business model.
                        We are proud to be what Forbes calls "the impact model of the future," a for profit social
                        enterprise.</p> */}
                {/* </div> */}
                {/* <div className="col-lg-6"> */}
                {/* <img src="images/bg2.jpg" className="img-fluid" alt=" " /> */}
                {/* </div> */}
                {/* </div> */}
                {/* </div> */}
                ...
                <div className="py-sm-1 py-1">
                    <div className="container py-xl-4 py-lg-2">
                        <h3 className="tittle-w3l text-center text-black mb-lg-5 mb-sm-4 mb-3">
                            <span>W</span>hy
                <span>G</span>oods
                <span>N</span>ot
                <span>C</span>ash</h3>
                        <div className="bg-white py-1">
                            <div className="container py-1">
                                <div className="row align-items-center mb-5">
                                    <p className="font-italic text-center">YouGiveGoods was established on the belief that some
                            ...
                            being damaged, old, or otherwise unable to be used by the charity.</p>
                                    <div className="col-lg-6 order-2 order-lg-1">
                                        <i className="fa fa-bar-chart fa-2x mb-3 text-primary"></i>
                                        <h2 className="font-weight-light">No subscription fee, no commitment</h2>
                                        <p className="font-italic text-muted mb-4">YouGiveGoods collects no fees from the charity or
                                ...
                                marketing tools, unbeatable customer service, corporate event reporting and more.</p>
                                    ...
                                    <div className="col-lg-6 order-2 order-lg-1">
                                        ...
                                        <p className="font-italic text-muted mb-4">YouGiveGoods makes charitable giving easy and
                                ...
                                in local communities activities by getting new, needed goods to charities.</p>
                                    ...
                                    <div className="col-lg-6 order-2 order-lg-1">
                                        ...
                                        <p className="font-italic text-muted mb-4">As an added benefit to our corporate partners,
                                            YouGiveGoods service includes integration with your corporate match, foundation match,
                ...
                <span>U</span>s
                        ...
                        <div className="container py-1">
                            <div className="row align-items-center mb-5">
                                ...
                                <div className="col-lg-6 order-2 order-lg-1">
                                    <img src="images/aboutUs1.jpg" className="img-thumbnail" alt=" " />
                                    <img src="images/aboutUs2.jpg" className="img-thumbnail" alt=" " />
                                </div>
                            </div>
                        </div>
                    </div>
